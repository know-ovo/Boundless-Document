      ...
      <section className="lp-section lp-body-section" id="lp-ecosystem">
        <div className="lp-container">
          ...
          <div className="lp-eco-grid">
            <div className="lp-eco-card"><h3>editor</h3><p>基于 Milkdown 的 WYSIWYG 编辑器，源码/预览双模式。</p></div>
      ...
      <section className="lp-section lp-body-section lp-cta-section" id="lp-cta">
        <div className="lp-container">
          ...
          <div className="lp-cta-actions">
            ...
            <button className="lp-btn lp-btn-secondary" onClick={() => window.open('https://github.com', '_blank')}>
